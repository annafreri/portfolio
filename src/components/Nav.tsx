...
interface Props {
  navItem: 'work' | 'about' | 'contact' | null;
...
export default function Nav({ setNavItem }: Props) {
  ...
  return (
    <nav className="fixed bottom-8 left-1/2 transform -translate-x-1/2 px-1 py-1 bg-gray-300/70 rounded-full flex items-center justify-center gap-1 shadow-lg backdrop-blur z-50 transition-all duration-300 ease-in-out">
      <button
